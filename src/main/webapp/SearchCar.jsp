<%@page import="com.jspider.cardekhoservletandJDBC.JDBC.SearchCar"%>
<%@page import="com.jspider.cardekhoservletandJDBC.login.SearchCarId"%>
...
body {
	background-image:
		url("https://wallpapercave.com/wp/wp8515398.jpg");
...
<body>
	...
	<div id="div1" class="mid" align="left">
	 ...
	 <section class="mid" id="sec">
        ...
        <div id="button">
        <button><a href="http://localhost:8080/cardekhoservletandJDBC/ViewCar.jsp" class="btn">View ALL Cars</a></button>
        <button onclick="getForm()"><a href="#" class="btn">Search Car By ID</a></button>
        <button onclick="getForm1()"><a href="#" class="btn">Search Car By Name</a></button>
        <button onclick="getForm2()"><a href="#" class="btn">Search Car By Model</a></button>
        </div>
        <div id="button1">
         <button onclick="getForm3()"><a href="#" class="btn">Search Car By Brand</a></button>
        <button onclick="getForm4()"><a href="#" class="btn">Search Car By Price</a></button>
        <button onclick="getForm5()"><a href="#" class="btn">Search Car By Fuel Type </a></button>
        <button onclick="getForm6()"><a href="#" class="btn">Search Car By Color</a></button>
